...
if (db.problems.countDocuments() === 0) {
  ...
  },
  {
    ...
    "assumptions": [
      ...
      "The elements to be merged start from the beginning of each array"
    ],
    "constraints": [
      "nums1.length == m + n",
      "nums2.length == n",
  ...
  },
  {
    ...
    "assumptions": [
      "The string only contains the six bracket characters mentioned",
  ...
  print("Seeded " + db.problems.countDocuments() + " problems into code_execution_db.problems");
} else {
  print("problems collection already populated, skipping seed");
}
